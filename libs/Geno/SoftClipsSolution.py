...
'''
def Parser_AnalysisWithSoftClips(input_file, bam_files_dir, df, mutation, sampleName):
...
'''
def MAIN_AnalysisWithSoftClipsWrapper(input_path, myscreen_version, bam_files_path=''):
    if bam_files_path == '':
...
if __name__ == "__main__":
    ...
    if args.bams_path:
        ...
        bams_path = ''
    MAIN_AnalysisWithSoftClipsWrapper(args.VS2_files_path, args.MyScreen_version, bams_path)
