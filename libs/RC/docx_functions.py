...
from getInfo_functions import get_INFO_posRes, get_INFO_decon
...
"""
def createReports(sample, sampleStatus, posResFiltered, decon_filtered, sampleInfoTable, office, output_folder, MyScreen_version):
